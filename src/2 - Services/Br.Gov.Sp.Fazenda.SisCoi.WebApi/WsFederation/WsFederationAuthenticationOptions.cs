...
namespace Br.Gov.Sp.Fazenda.SisCoi.WebApi.WsFederation
{
    ...
    {
        private SecurityTokenHandler  _securityTokenHandlers;
        ...
        /// </summary>
        public Microsoft.IdentityModel.Protocols.IConfigurationManager<WsFederationConfiguration>  ConfigurationManager { get; set; }
        ...
        /// </summary>
        public SecurityTokenHandler SecurityTokenHandlers
        {
    ...
    {
        public override async Task<TokenValidationResult> ValidateTokenAsync(string token, TokenValidationParameters tokenValidationParameters)
        {
                ...
                (tokenValidationParameters.IssuerSigningKeys?.Any() != true))
            {
                ...
                tokenValidationParameters.ConfigurationManager.GetBaseConfigurationAsync(CancellationToken.None);
